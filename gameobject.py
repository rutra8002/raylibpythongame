...
class GameObject:
    ...
    def check_vertical_collision(self, other):
        touching_top = other.y + other.height+1 > self.y and other.y-1 < self.y
        touching_bottom = other.y +1 < self.y + self.height and other.y + other.height -1> self.y + self.height
    ...
    def check_horizontal_collision(self, other):
        touching_left = other.x + other.width +1> self.x and other.x-1 < self.x
        touching_right = other.x +1 < self.x + self.width and other.x + other.width -1 > self.x + self.width
